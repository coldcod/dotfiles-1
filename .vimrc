...
Plugin 'vim-scripts/indentpython.vim' 				" python audo-indentation
Plugin 'scrooloose/syntastic'					" checks syntax on each save
Plugin 'nvie/vim-flake8'					" checks syntax on each save (PEP8 support)
" Plugin 'altercation/vim-colors-solarized'
 Plugin 'Lokaltog/powerline', {'rtp': 'powerline/bindings/vim/'}
" Plugin 'xolox/vim-notes'					" note taking plugin
" Plugin 'xolox/vim-misc'						" addtional package for vim-notes
